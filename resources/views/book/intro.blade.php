...
<p>Dearest reader, this is an early version of the forthcoming book, &quot;Easy React: Build Powerful Web Apps Using Modern JavaScript Technologies&quot;. As such, you'll quite possibly find a mistake or two, and perhaps even a horrible error or half-truth. Such is life in the dangerous world of reading technical book drafts. I can however assure you I'm working tirelessly to complete a quality book, and very much value your feedback. E-mail me anytime at wj@wjgilmore.com.</p>
<p>I've been a professional web developer for the past 18 years or so, having built my first commercial website back in 1997. It has been incredibly exciting to watch the web evolve so dramatically over the course of the past two decades, transforming from a mere curiosity to a medium so indispensable to business and life. It has also been challenging, because this rapid pace of change has meant constantly evaluating new technologies and occasionally putting a few of them to good use for both myself and my clients. For the most part I believe I've succeeded at this challenge, having built dozens of solutions using a laundry list of powerful languages, databases, and frameworks.</p>
...
<p>Above all, this calculated limitation of scope suggests <em>simplicity</em>. Having struggled with technologies that seem to embrace anything but simplicity, this is in my mind precisely what makes React such an attractive technology. You can integrate a simple React-driven widget (known as <em>elements</em> and <em>components</em> in React lingo; more about this in the next chapter) into an existing web application literally within minutes, and then introduce additional components and other more advanced features as you desire.</p>
...
<p>In chapter 2 we'll build upon React fundamentals by focusing on several key aspects of developing a React-powered web application. You'll learn about React's unconventional approach to CSS integration, how to create manageable layouts, and various approaches to defining and managing routes.</p>
<h3 id="chapter-4.-getting-fluxxy-with-it">Chapter 4. Getting Fluxxy With It</h3>
<p>Everything we've discussed so far has been primarily focused on React's view-oriented capabilities. However in order to build a complete application you'll ultimately need look at the larger picture. In this chapter you'll learn how to do so through an introduction to Facebook's Flux application architecture. I'll also introduce you to several open source, Flux-inspired solutions such as Redux.</p>
...
<p>In this final chapter, we'll have a look at React Native, a fantastic solution for building and deploying applications on native platforms such as iOS and Android using the very same React and JavaScript technologies you already know and love.</p>
...
<ul>
<li><p><a href="https://git-scm.com/">Git</a>: We'll tangentially use Git throughout the book to retrieve the companion repository and switch between example branches. If you're not familiar with Git check out Scott Chacon's great book, &quot;<a href="https://git-scm.com/book">Pro Git</a>&quot;.</p></li>
