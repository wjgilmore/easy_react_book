...
<p>Above all, this calculated limitation of scope espouses <em>simplicity</em>. Having had many a struggle with technologies that seem to embrace anything but, this is in my mind precisely what makes React such an attractive technology. You can integrate a simple React-driven widget (known as <em>elements</em> and <em>components</em> in React lingo; more about this in the next chapter) into an existing web application literally within minutes, and then methodically introduce additional components and other more advanced features as desired.</p>
